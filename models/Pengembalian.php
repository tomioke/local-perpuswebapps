...
/**
 * Table class for pengembalian
 */
class Pengembalian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pengembalian';
        $this->TableName = 'pengembalian';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pengembalian`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_kembali
        $this->id_kembali = new DbField('pengembalian', 'pengembalian', 'x_id_kembali', 'id_kembali', '`id_kembali`', '`id_kembali`', 3, 100, -1, false, '`id_kembali`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // id_peminjaman
        $this->id_peminjaman = new DbField('pengembalian', 'pengembalian', 'x_id_peminjaman', 'id_peminjaman', '`id_peminjaman`', '`id_peminjaman`', 3, 100, -1, false, '`id_peminjaman`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->id_peminjaman->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->id_peminjaman->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->id_peminjaman->Lookup = new Lookup('id_peminjaman', 'peminjaman', false, 'id_peminjaman', ["berita_peminjaman","","",""], [], [], [], [], [], [], '', '');
        ...
        // tgl_kembali
        $this->tgl_kembali = new DbField('pengembalian', 'pengembalian', 'x_tgl_kembali', 'tgl_kembali', '`tgl_kembali`', CastDateFieldForLike("`tgl_kembali`", 0, "DB"), 133, 10, 0, false, '`tgl_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kondisi_buku_kembali = new DbField('pengembalian', 'pengembalian', 'x_kondisi_buku_kembali', 'kondisi_buku_kembali', '`kondisi_buku_kembali`', '`kondisi_buku_kembali`', 200, 200, -1, false, '`kondisi_buku_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pengembalian`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PengembalianList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PengembalianEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PengembalianAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PengembalianView";
            case Config("API_ADD_ACTION"):
                return "PengembalianAdd";
            case Config("API_EDIT_ACTION"):
                return "PengembalianEdit";
            case Config("API_DELETE_ACTION"):
                return "PengembalianDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PengembalianView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PengembalianView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PengembalianAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PengembalianAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PengembalianEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PengembalianAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PengembalianDelete", $this->getUrlParm());
    }
