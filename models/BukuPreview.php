 ...
 * Page class
 */
class BukuPreview extends Buku
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BukuPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "penerbit") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=penerbit&" . GetForeignKeyUrl("fk_id_penerbit", $this->penerbit->QueryStringValue) . "";
        }
        if ($masterTblVar == "pengarang") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pengarang&" . GetForeignKeyUrl("fk_id_pengarang", $this->pengarang->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "penerbit") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->penerbit->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "pengarang") {
            $find = "`pengarang`=";
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->pengarang->setQueryStringValue($val);
            }
        }
    }
