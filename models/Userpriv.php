...
class Userpriv extends Level
{
    ...
    public function run()
    {
        ...
        $Breadcrumb->add("list", "level", "LevelList", "", "level");
        ...
        if (Post("action") == "") {
            ...
            if (Get("ID_Level") !== null) {
                $this->ID_Level->setQueryStringValue(Get("ID_Level"));
            } else {
                $this->terminate("LevelList"); // Return to list
                return;
            }
            if ($this->ID_Level->QueryStringValue == "-1") {
            ...
            $this->ID_Level->setFormValue(Post("x_ID_Level"));
        ...
        if ($Security->hasUserLevelID($this->ID_Level->CurrentValue)) {
            $this->terminate("LevelList"); // Return to list
            return;
        }
