 ...
 * Page class
 */
class PeminjamanPreview extends Peminjaman
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeminjamanPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "anggota") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=anggota&" . GetForeignKeyUrl("fk_id_anggota", $this->id_anggota->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "anggota") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_anggota->setQueryStringValue($val);
            }
        }
    }
