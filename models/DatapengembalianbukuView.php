 ...
 * Page class
 */
class DatapengembalianbukuView extends Datapengembalianbuku
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DatapengembalianbukuView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_kembali") ?? Route("id_kembali")) !== null) {
                ...
                $returnUrl = "DatapengembalianbukuList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DatapengembalianbukuList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DatapengembalianbukuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DatapengembalianbukuList"), "", $this->TableVar, true);
        $pageId = "view";
