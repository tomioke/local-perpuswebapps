...
class BukuDelete extends Buku
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BukuList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BukuList"); // Return to list
                return;
            }
        }
