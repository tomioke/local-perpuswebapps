...
/**
 * Table class for data-pengembalian-buku
 */
class Datapengembalianbuku extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'datapengembalianbuku';
        $this->TableName = 'data-pengembalian-buku';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`data-pengembalian-buku`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // berita_peminjaman
        $this->berita_peminjaman = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_berita_peminjaman', 'berita_peminjaman', '`berita_peminjaman`', '`berita_peminjaman`', 200, 200, -1, false, '`berita_peminjaman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_buku
        $this->id_buku = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_id_buku', 'id_buku', '`id_buku`', '`id_buku`', 3, 100, -1, false, '`id_buku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_anggota
        $this->id_anggota = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_id_anggota', 'id_anggota', '`id_anggota`', '`id_anggota`', 3, 100, -1, false, '`id_anggota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_peminjaman
        $this->tgl_peminjaman = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_tgl_peminjaman', 'tgl_peminjaman', '`tgl_peminjaman`', CastDateFieldForLike("`tgl_peminjaman`", 0, "DB"), 133, 10, 0, false, '`tgl_peminjaman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tgl_peminjaman->Nullable = false; // NOT NULL field
        $this->tgl_peminjaman->Required = true; // Required field
        ...
        // rencana_tgl_kembali
        $this->rencana_tgl_kembali = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_rencana_tgl_kembali', 'rencana_tgl_kembali', '`rencana_tgl_kembali`', CastDateFieldForLike("`rencana_tgl_kembali`", 0, "DB"), 133, 10, 0, false, '`rencana_tgl_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kondisi_buku_peminjaman = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_kondisi_buku_peminjaman', 'kondisi_buku_peminjaman', '`kondisi_buku_peminjaman`', '`kondisi_buku_peminjaman`', 200, 200, -1, false, '`kondisi_buku_peminjaman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_kembali
        $this->tgl_kembali = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_tgl_kembali', 'tgl_kembali', '`tgl_kembali`', CastDateFieldForLike("`tgl_kembali`", 0, "DB"), 133, 10, 0, false, '`tgl_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kondisi_buku_kembali = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_kondisi_buku_kembali', 'kondisi_buku_kembali', '`kondisi_buku_kembali`', '`kondisi_buku_kembali`', 200, 200, -1, false, '`kondisi_buku_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Lama_Kembali
        $this->Lama_Kembali = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_Lama_Kembali', 'Lama_Kembali', '`Lama_Kembali`', '`Lama_Kembali`', 20, 10, -1, false, '`Lama_Kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Lama_Kembali->Nullable = false; // NOT NULL field
        $this->Lama_Kembali->Required = true; // Required field
        ...
        // Lama_Pinjam
        $this->Lama_Pinjam = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_Lama_Pinjam', 'Lama_Pinjam', '`Lama_Pinjam`', '`Lama_Pinjam`', 20, 10, -1, false, '`Lama_Pinjam`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Lama_Pinjam->Nullable = false; // NOT NULL field
        $this->Lama_Pinjam->Required = true; // Required field
        ...
        // Terlambat
        $this->Terlambat = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_Terlambat', 'Terlambat', '`Terlambat`', '`Terlambat`', 20, 11, -1, false, '`Terlambat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Terlambat->Nullable = false; // NOT NULL field
        $this->Terlambat->Required = true; // Required field
        ...
        // id_kembali
        $this->id_kembali = new DbField('datapengembalianbuku', 'data-pengembalian-buku', 'x_id_kembali', 'id_kembali', '`id_kembali`', '`id_kembali`', 3, 100, -1, false, '`id_kembali`', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`data-pengembalian-buku`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("DatapengembalianbukuList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "DatapengembalianbukuView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DatapengembalianbukuEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DatapengembalianbukuAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DatapengembalianbukuView";
            case Config("API_ADD_ACTION"):
                return "DatapengembalianbukuAdd";
            case Config("API_EDIT_ACTION"):
                return "DatapengembalianbukuEdit";
            case Config("API_DELETE_ACTION"):
                return "DatapengembalianbukuDelete";
            case Config("API_LIST_ACTION"):
                return "DatapengembalianbukuList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DatapengembalianbukuView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DatapengembalianbukuView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DatapengembalianbukuAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DatapengembalianbukuAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DatapengembalianbukuEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DatapengembalianbukuAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DatapengembalianbukuDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->id_buku->EditValue = $this->id_buku->CurrentValue;
        ...
        if (!$Security->isAdmin() && $Security->isLoggedIn() && !$this->userIDAllow("info")) { // Non system admin
            ...
            $this->id_anggota->EditValue = FormatNumber($this->id_anggota->EditValue, 0, -2, -2, -2);
            $this->id_anggota->ViewCustomAttributes = "";
        } else {
            $this->id_anggota->EditValue = $this->id_anggota->CurrentValue;
        ...
        // tgl_peminjaman
        $this->tgl_peminjaman->EditAttrs["class"] = "form-control";
        $this->tgl_peminjaman->EditCustomAttributes = "";
        $this->tgl_peminjaman->EditValue = FormatDateTime($this->tgl_peminjaman->CurrentValue, 8);
        $this->tgl_peminjaman->PlaceHolder = RemoveHtml($this->tgl_peminjaman->caption());
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `data-pengembalian-buku`";
