 ...
 * Page class
 */
class PeminjamanDelete extends Peminjaman
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeminjamanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PeminjamanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("PeminjamanList"); // Return to list
            return;
        }
