...
/**
 * Table class for data-kembalian-buku
 */
class Datakembalianbuku extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'datakembalianbuku';
        $this->TableName = 'data-kembalian-buku';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`data-kembalian-buku`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // berita_peminjaman
        $this->berita_peminjaman = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_berita_peminjaman', 'berita_peminjaman', '`berita_peminjaman`', '`berita_peminjaman`', 200, 200, -1, false, '`berita_peminjaman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_buku
        $this->id_buku = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_id_buku', 'id_buku', '`id_buku`', '`id_buku`', 3, 100, -1, false, '`EV__id_buku`', true, true, true, 'FORMATTED TEXT', 'SELECT');
        ...
        // id_anggota
        $this->id_anggota = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_id_anggota', 'id_anggota', '`id_anggota`', '`id_anggota`', 3, 100, -1, false, '`EV__id_anggota`', true, true, true, 'FORMATTED TEXT', 'SELECT');
        ...
        // tgl_peminjaman
        $this->tgl_peminjaman = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_tgl_peminjaman', 'tgl_peminjaman', '`tgl_peminjaman`', CastDateFieldForLike("`tgl_peminjaman`", 0, "DB"), 133, 10, 0, false, '`tgl_peminjaman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rencana_tgl_kembali
        $this->rencana_tgl_kembali = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_rencana_tgl_kembali', 'rencana_tgl_kembali', '`rencana_tgl_kembali`', CastDateFieldForLike("`rencana_tgl_kembali`", 0, "DB"), 133, 10, 0, false, '`rencana_tgl_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kondisi_buku_peminjaman = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_kondisi_buku_peminjaman', 'kondisi_buku_peminjaman', '`kondisi_buku_peminjaman`', '`kondisi_buku_peminjaman`', 200, 200, -1, false, '`kondisi_buku_peminjaman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_kembali
        $this->tgl_kembali = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_tgl_kembali', 'tgl_kembali', '`tgl_kembali`', CastDateFieldForLike("`tgl_kembali`", 0, "DB"), 133, 10, 0, false, '`tgl_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kondisi_buku_kembali = new DbField('datakembalianbuku', 'data-kembalian-buku', 'x_kondisi_buku_kembali', 'kondisi_buku_kembali', '`kondisi_buku_kembali`', '`kondisi_buku_kembali`', 200, 200, -1, false, '`kondisi_buku_kembali`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`data-kembalian-buku`";
    }
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `nama_buku` FROM `buku` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`id_buku` = `data-kembalian-buku`.`id_buku` LIMIT 1) AS `EV__id_buku`, (SELECT `nama_anggota` FROM `anggota` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`id_anggota` = `data-kembalian-buku`.`id_anggota` LIMIT 1) AS `EV__id_anggota` FROM `data-kembalian-buku`)";
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("DatakembalianbukuList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "DatakembalianbukuView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DatakembalianbukuEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DatakembalianbukuAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DatakembalianbukuView";
            case Config("API_ADD_ACTION"):
                return "DatakembalianbukuAdd";
            case Config("API_EDIT_ACTION"):
                return "DatakembalianbukuEdit";
            case Config("API_DELETE_ACTION"):
                return "DatakembalianbukuDelete";
            case Config("API_LIST_ACTION"):
                return "DatakembalianbukuList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DatakembalianbukuView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DatakembalianbukuView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DatakembalianbukuAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DatakembalianbukuAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DatakembalianbukuEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DatakembalianbukuAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DatakembalianbukuDelete", $this->getUrlParm());
    }
