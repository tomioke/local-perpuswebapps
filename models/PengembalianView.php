 ...
 * Page class
 */
class PengembalianView extends Pengembalian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengembalianView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_kembali") ?? Route("id_kembali")) !== null) {
                ...
                $returnUrl = "PengembalianList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PengembalianList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PengembalianList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
