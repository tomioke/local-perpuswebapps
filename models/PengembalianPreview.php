 ...
 * Page class
 */
class PengembalianPreview extends Pengembalian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengembalianPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "peminjaman") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=peminjaman&" . GetForeignKeyUrl("fk_id_peminjaman", $this->id_peminjaman->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "peminjaman") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_peminjaman->setQueryStringValue($val);
            }
        }
    }
