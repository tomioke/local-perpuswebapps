 ...
 * Page class
 */
class PengembalianDelete extends Pengembalian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengembalianDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PengembalianList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PengembalianList"); // Return to list
                return;
            }
        }
