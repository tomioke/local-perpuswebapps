...
class AnggotaEdit extends Anggota
{
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_anggota") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_anggota->setQueryStringValue($keyValue);
                $this->id_anggota->setOldValue($this->id_anggota->QueryStringValue);
            } elseif (Post("id_anggota") !== null) {
                $this->id_anggota->setFormValue(Post("id_anggota"));
                $this->id_anggota->setOldValue($this->id_anggota->FormValue);
            } else {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // nama_anggota
            $this->nama_anggota->setDbValueDef($rsnew, $this->nama_anggota->CurrentValue, "", $this->nama_anggota->ReadOnly);
            ...
            // tmp_lahir
            $this->tmp_lahir->setDbValueDef($rsnew, $this->tmp_lahir->CurrentValue, "", $this->tmp_lahir->ReadOnly);
            ...
            // no_handphone
            $this->no_handphone->setDbValueDef($rsnew, $this->no_handphone->CurrentValue, "", $this->no_handphone->ReadOnly);
