 ...
 * Page class
 */
class DatapengemalianbukuList extends Datapengemalianbuku
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DatapengemalianbukuList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fdatapengemalianbukulist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "DatapengemalianbukuAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "DatapengemalianbukuDelete";
        $this->MultiUpdateUrl = "DatapengemalianbukuUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fdatapengemalianbukulistsrch";
    ...
    public function run()
    {
        ...
        $this->tgl_peminjaman->Visible = false;
        $this->rencana_tgl_kembali->Visible = false;
        $this->kondisi_buku_peminjaman->Visible = false;
        $this->tgl_kembali->setVisibility();
        $this->kondisi_buku_kembali->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->id_kembali->AdvancedSearch->toJson(), ","); // Field id_kembali
        ...
        $filterList = Concat($filterList, $this->tgl_kembali->AdvancedSearch->toJson(), ","); // Field tgl_kembali
        $filterList = Concat($filterList, $this->kondisi_buku_kembali->AdvancedSearch->toJson(), ","); // Field kondisi_buku_kembali
        $filterList = Concat($filterList, $this->Lama_Kembali->AdvancedSearch->toJson(), ","); // Field Lama_Kembali
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fdatapengemalianbukulistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field id_kembali
        $this->id_kembali->AdvancedSearch->SearchValue = @$filter["x_id_kembali"];
        $this->id_kembali->AdvancedSearch->SearchOperator = @$filter["z_id_kembali"];
        $this->id_kembali->AdvancedSearch->SearchCondition = @$filter["v_id_kembali"];
        $this->id_kembali->AdvancedSearch->SearchValue2 = @$filter["y_id_kembali"];
        $this->id_kembali->AdvancedSearch->SearchOperator2 = @$filter["w_id_kembali"];
        $this->id_kembali->AdvancedSearch->save();
        ...
        // Field tgl_kembali
        $this->tgl_kembali->AdvancedSearch->SearchValue = @$filter["x_tgl_kembali"];
        $this->tgl_kembali->AdvancedSearch->SearchOperator = @$filter["z_tgl_kembali"];
        $this->tgl_kembali->AdvancedSearch->SearchCondition = @$filter["v_tgl_kembali"];
        $this->tgl_kembali->AdvancedSearch->SearchValue2 = @$filter["y_tgl_kembali"];
        $this->tgl_kembali->AdvancedSearch->SearchOperator2 = @$filter["w_tgl_kembali"];
        $this->tgl_kembali->AdvancedSearch->save();

        // Field kondisi_buku_kembali
        $this->kondisi_buku_kembali->AdvancedSearch->SearchValue = @$filter["x_kondisi_buku_kembali"];
        $this->kondisi_buku_kembali->AdvancedSearch->SearchOperator = @$filter["z_kondisi_buku_kembali"];
        $this->kondisi_buku_kembali->AdvancedSearch->SearchCondition = @$filter["v_kondisi_buku_kembali"];
        $this->kondisi_buku_kembali->AdvancedSearch->SearchValue2 = @$filter["y_kondisi_buku_kembali"];
        $this->kondisi_buku_kembali->AdvancedSearch->SearchOperator2 = @$filter["w_kondisi_buku_kembali"];
        $this->kondisi_buku_kembali->AdvancedSearch->save();

        // Field Lama_Kembali
        $this->Lama_Kembali->AdvancedSearch->SearchValue = @$filter["x_Lama_Kembali"];
        $this->Lama_Kembali->AdvancedSearch->SearchOperator = @$filter["z_Lama_Kembali"];
        $this->Lama_Kembali->AdvancedSearch->SearchCondition = @$filter["v_Lama_Kembali"];
        $this->Lama_Kembali->AdvancedSearch->SearchValue2 = @$filter["y_Lama_Kembali"];
        $this->Lama_Kembali->AdvancedSearch->SearchOperator2 = @$filter["w_Lama_Kembali"];
        $this->Lama_Kembali->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->kondisi_buku_kembali, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tgl_kembali, $ctrl); // tgl_kembali
            $this->updateSort($this->Lama_Kembali, $ctrl); // Lama_Kembali
            $this->updateSort($this->Lama_Pinjam, $ctrl); // Lama_Pinjam
            $this->updateSort($this->Terlambat, $ctrl); // Terlambat
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`tgl_kembali` ASC";
            if ($this->getSqlOrderBy() != "") {
                $useDefaultSort = true;
                if ($this->tgl_kembali->getSort() != "") {
                    $useDefaultSort = false;
                }
                if ($useDefaultSort) {
                    $this->tgl_kembali->setSort("ASC");
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->kondisi_buku_kembali->setSort("");
                $this->Lama_Kembali->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView() && $this->showOptionLink("view")) {
                if (IsMobile()) {
                    ...
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"datapengemalianbuku\" data-caption=\"" . $viewcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,url:'" . HtmlEncode(GetUrl($this->ViewUrl)) . "',btn:null});\">" . $Language->phrase("ViewLink") . "</a>";
                }
            } else {
                $opt->Body = "";
            }
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_kembali->CurrentValue) . "\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdatapengemalianbukulistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdatapengemalianbukulistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fdatapengemalianbukulist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fdatapengemalianbukulist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fdatapengemalianbukulist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fdatapengemalianbukulist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_datapengemalianbuku" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_datapengemalianbuku\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fdatapengemalianbukulist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fdatapengemalianbukulistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
