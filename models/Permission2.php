 ...
 */
class Permission2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'permission2';
        $this->TableName = 'permission';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`permission`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Table_Name
        $this->Table_Name = new DbField('permission2', 'permission', 'x_Table_Name', 'Table_Name', '`Table_Name`', '`Table_Name`', 200, 200, -1, false, '`Table_Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ID_Level
        $this->ID_Level = new DbField('permission2', 'permission', 'x_ID_Level', 'ID_Level', '`ID_Level`', '`ID_Level`', 3, 20, -1, false, '`ID_Level`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Permission
        $this->_Permission = new DbField('permission2', 'permission', 'x__Permission', 'Permission', '`Permission`', '`Permission`', 3, 200, -1, false, '`Permission`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`permission`";
    }
    ...
    {
        global $Language;
        if ($pageName == "Permission2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "Permission2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "Permission2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "Permission2View";
            case Config("API_ADD_ACTION"):
                return "Permission2Add";
            case Config("API_EDIT_ACTION"):
                return "Permission2Edit";
            case Config("API_DELETE_ACTION"):
                return "Permission2Delete";
            case Config("API_LIST_ACTION"):
                return "Permission2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Permission2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("Permission2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "Permission2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "Permission2Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("Permission2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Permission2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("Permission2Delete", $this->getUrlParm());
    }
