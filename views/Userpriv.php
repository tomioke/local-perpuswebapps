...
<input type="hidden" name="x_ID_Level" id="x_ID_Level" value="<?= $Page->ID_Level->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-user-priv">
<div class="card-header">
    <h3 class="card-title"><?= $Language->phrase("UserLevel") ?><?= $Security->getUserLevelName((int)$Page->ID_Level->CurrentValue) ?> (<?= $Page->ID_Level->CurrentValue ?>)</h3>
