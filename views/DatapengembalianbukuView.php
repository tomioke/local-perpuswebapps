...
// Page object
$DatapengembalianbukuView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fdatapengembalianbukuview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fdatapengembalianbukuview = currentForm = new ew.Form("fdatapengembalianbukuview", "view");
    loadjs.done("fdatapengembalianbukuview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdatapengembalianbukuview" id="fdatapengembalianbukuview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id_kembali->Visible) { // id_kembali ?>
    <tr id="r_id_kembali">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_id_kembali"><?= $Page->id_kembali->caption() ?></span></td>
        <td data-name="id_kembali" <?= $Page->id_kembali->cellAttributes() ?>>
<span id="el_datapengembalianbuku_id_kembali">
...
<?php if ($Page->berita_peminjaman->Visible) { // berita_peminjaman ?>
    <tr id="r_berita_peminjaman">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_berita_peminjaman"><?= $Page->berita_peminjaman->caption() ?></span></td>
        <td data-name="berita_peminjaman" <?= $Page->berita_peminjaman->cellAttributes() ?>>
<span id="el_datapengembalianbuku_berita_peminjaman">
...
<?php if ($Page->id_buku->Visible) { // id_buku ?>
    <tr id="r_id_buku">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_id_buku"><?= $Page->id_buku->caption() ?></span></td>
        <td data-name="id_buku" <?= $Page->id_buku->cellAttributes() ?>>
<span id="el_datapengembalianbuku_id_buku">
...
<?php if ($Page->id_anggota->Visible) { // id_anggota ?>
    <tr id="r_id_anggota">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_id_anggota"><?= $Page->id_anggota->caption() ?></span></td>
        <td data-name="id_anggota" <?= $Page->id_anggota->cellAttributes() ?>>
<span id="el_datapengembalianbuku_id_anggota">
...
<?php if ($Page->tgl_peminjaman->Visible) { // tgl_peminjaman ?>
    <tr id="r_tgl_peminjaman">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_tgl_peminjaman"><?= $Page->tgl_peminjaman->caption() ?></span></td>
        <td data-name="tgl_peminjaman" <?= $Page->tgl_peminjaman->cellAttributes() ?>>
<span id="el_datapengembalianbuku_tgl_peminjaman">
...
<?php if ($Page->rencana_tgl_kembali->Visible) { // rencana_tgl_kembali ?>
    <tr id="r_rencana_tgl_kembali">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_rencana_tgl_kembali"><?= $Page->rencana_tgl_kembali->caption() ?></span></td>
        <td data-name="rencana_tgl_kembali" <?= $Page->rencana_tgl_kembali->cellAttributes() ?>>
<span id="el_datapengembalianbuku_rencana_tgl_kembali">
...
<?php if ($Page->kondisi_buku_peminjaman->Visible) { // kondisi_buku_peminjaman ?>
    <tr id="r_kondisi_buku_peminjaman">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_kondisi_buku_peminjaman"><?= $Page->kondisi_buku_peminjaman->caption() ?></span></td>
        <td data-name="kondisi_buku_peminjaman" <?= $Page->kondisi_buku_peminjaman->cellAttributes() ?>>
<span id="el_datapengembalianbuku_kondisi_buku_peminjaman">
...
<?php if ($Page->tgl_kembali->Visible) { // tgl_kembali ?>
    <tr id="r_tgl_kembali">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_tgl_kembali"><?= $Page->tgl_kembali->caption() ?></span></td>
        <td data-name="tgl_kembali" <?= $Page->tgl_kembali->cellAttributes() ?>>
<span id="el_datapengembalianbuku_tgl_kembali">
...
<?php if ($Page->kondisi_buku_kembali->Visible) { // kondisi_buku_kembali ?>
    <tr id="r_kondisi_buku_kembali">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_kondisi_buku_kembali"><?= $Page->kondisi_buku_kembali->caption() ?></span></td>
        <td data-name="kondisi_buku_kembali" <?= $Page->kondisi_buku_kembali->cellAttributes() ?>>
<span id="el_datapengembalianbuku_kondisi_buku_kembali">
...
<?php if ($Page->Lama_Kembali->Visible) { // Lama_Kembali ?>
    <tr id="r_Lama_Kembali">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_Lama_Kembali"><?= $Page->Lama_Kembali->caption() ?></span></td>
        <td data-name="Lama_Kembali" <?= $Page->Lama_Kembali->cellAttributes() ?>>
<span id="el_datapengembalianbuku_Lama_Kembali">
...
<?php if ($Page->Lama_Pinjam->Visible) { // Lama_Pinjam ?>
    <tr id="r_Lama_Pinjam">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_Lama_Pinjam"><?= $Page->Lama_Pinjam->caption() ?></span></td>
        <td data-name="Lama_Pinjam" <?= $Page->Lama_Pinjam->cellAttributes() ?>>
<span id="el_datapengembalianbuku_Lama_Pinjam">
...
<?php if ($Page->Terlambat->Visible) { // Terlambat ?>
    <tr id="r_Terlambat">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_datapengembalianbuku_Terlambat"><?= $Page->Terlambat->caption() ?></span></td>
        <td data-name="Terlambat" <?= $Page->Terlambat->cellAttributes() ?>>
<span id="el_datapengembalianbuku_Terlambat">
