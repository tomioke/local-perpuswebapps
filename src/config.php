...
$CONFIG = [
    ...
    "USER_LEVEL_DBID" => "DB",
    "USER_LEVEL_TABLE" => "`level`",
    "USER_LEVEL_ID_FIELD" => "`ID_Level`",
    "USER_LEVEL_NAME_FIELD" => "`Level_Name`",

    // User Level privileges table/field names
    "USER_LEVEL_PRIV_DBID" => "DB",
    "USER_LEVEL_PRIV_TABLE" => "`permission`",
    ...
    "USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD" => "`ID_Level`",
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,tar,ppt,pptx", // Allowed file extensions
    ...
    "MAX_FILE_SIZE" => 99999999, // Max file size
